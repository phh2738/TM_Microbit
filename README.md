...
<!-- 문서의 body 시작 -->
    ...
    <div class="container">
        <ul class="list">
          ...
          <li class="tab-button" id="tab02"><a href="javascript:tabMenuClick(2);">TeachableMachine Image Model for MCU</a></li>
          <li class="tab-button" id="tab03"><a href="javascript:tabMenuClick(3);">TeachableMachine Pose Model for MCU</a></li>
          <li class="tab-button" id="tab04"><a href="javascript:tabMenuClick(4);">TeachableMachine Voice Model for MCU(배경소음)</a></li>    
        </ul>
      </div><br>
